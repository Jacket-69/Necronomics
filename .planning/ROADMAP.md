...
- [ ] 02-01-PLAN.md — Backend: Rust model, SQL queries, Tauri commands, TypeScript types, icon migration
- [ ] 02-02-PLAN.md — Zustand store, category list page with tabs/hierarchy/context menu
- [ ] 02-03-PLAN.md — Category form modal (create/edit), icon picker, delete modal with guards
...
_Last updated: 2026-02-27 after Phase 1 planning_
